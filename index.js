...
const contractAddress = '0xC280ad512d7A4B2D206B85553e1fA39838Db7633';

// You need the ABI of your contract
const contractABI = [
    {
      "inputs": [
        {
...
async function getAmount() {
  ...
  events.forEach(async event => {
    if (event.args.value == undefined) {
      ...
      console.log("AMOUNT: ", ethers.utils.formatEther(event.args.value))
      return amount
    }
  })
...
async function getTimestamp () {
  ...
  events.forEach(async event => {
    ...
    console.log(`Event Timestamp: ${newDate}`);
    return newDate;
  })
}
